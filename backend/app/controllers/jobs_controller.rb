class JobsController < ApplicationController
  ...
  def create
    ...
    job = current_user.jobs.create!(job_params.merge(status: params[:status] == "draft" ? "draft" : "pending", company: params[:company].presence || current_user.profile&.company_name || current_user.name))
